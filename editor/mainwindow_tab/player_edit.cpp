...
void player_edit::fill_players_data()
{
    ...
    ui->players_tab_hasshield->setChecked(Mediator::get_instance()->game_data.players[index].have_shield);
    ui->players_tab_maxshots->setValue(Mediator::get_instance()->game_data.players[index].max_shots);
    ui->damageModSpinBox->setValue(Mediator::get_instance()->game_data.players[index].damage_modifier);
    double move_speed = Mediator::get_instance()->game_data.players[index].move_speed;
    move_speed = move_speed / 10;
    //std::cout << "move_speed: " << move_speed << std::endl;
    ui->player_graphics_combo->setCurrentIndex(ui->player_graphics_combo->findText(QString(Mediator::get_instance()->game_data.players[index].graphic_filename)));

    common::fill_graphicfiles_combobox("/images/faces/", ui->playerFace_comboBox);
    ui->playerFace_comboBox->setCurrentIndex(ui->playerFace_comboBox->findText(QString(Mediator::get_instance()->game_data.players[index].face_filename)));

    ui->player_sprite_w->setValue(Mediator::get_instance()->game_data.players[index].sprite_size.width);
    ui->player_sprite_h->setValue(Mediator::get_instance()->game_data.players[index].sprite_size.height);

    ui->player_hitarea_x->setValue(Mediator::get_instance()->game_data.players[index].sprite_hit_area.x);
    ui->player_hitarea_y->setValue(Mediator::get_instance()->game_data.players[index].sprite_hit_area.y);
    ui->player_hitarea_w->setValue(Mediator::get_instance()->game_data.players[index].sprite_hit_area.w);
    ui->player_hitarea_h->setValue(Mediator::get_instance()->game_data.players[index].sprite_hit_area.h);
    ...
    ui->ColorValueIndicator3->setStyleSheet(QString("background-color: rgb(") + QString::number(Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].weapon_colors[Mediator::get_instance()->current_weapon].color3.r) + QString(", ") +  QString::number(Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].weapon_colors[Mediator::get_instance()->current_weapon].color3.g) + QString(", ") +  QString::number(Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].weapon_colors[Mediator::get_instance()->current_weapon].color3.b) + QString("); border-style: outset; border-width: 1px; border-color: black;"));

    ui->canDoubleJumpCheckBox->setChecked(Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].can_double_jump);
    ui->CanAirDashCheckBox->setChecked(Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].can_air_dash);
    ui->canShotDiagonal->setChecked(Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].can_shot_diagonal);
...
{
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].weapon_colors[Mediator::get_instance()->current_weapon].color1.r = Mediator::get_instance()->colormap[Mediator::get_instance()->picked_color_n].r;
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].weapon_colors[Mediator::get_instance()->current_weapon].color1.g = Mediator::get_instance()->colormap[Mediator::get_instance()->picked_color_n].g;
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].weapon_colors[Mediator::get_instance()->current_weapon].color1.b = Mediator::get_instance()->colormap[Mediator::get_instance()->picked_color_n].b;
...
{
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].weapon_colors[Mediator::get_instance()->current_weapon].color2.r = Mediator::get_instance()->colormap[Mediator::get_instance()->picked_color_n].r;
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].weapon_colors[Mediator::get_instance()->current_weapon].color2.g = Mediator::get_instance()->colormap[Mediator::get_instance()->picked_color_n].g;
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].weapon_colors[Mediator::get_instance()->current_weapon].color2.b = Mediator::get_instance()->colormap[Mediator::get_instance()->picked_color_n].b;
...
{
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].weapon_colors[Mediator::get_instance()->current_weapon].color3.r = Mediator::get_instance()->colormap[Mediator::get_instance()->picked_color_n].r;
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].weapon_colors[Mediator::get_instance()->current_weapon].color3.g = Mediator::get_instance()->colormap[Mediator::get_instance()->picked_color_n].g;
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].weapon_colors[Mediator::get_instance()->current_weapon].color3.b = Mediator::get_instance()->colormap[Mediator::get_instance()->picked_color_n].b;
...
void player_edit::on_player_graphics_combo_currentIndexChanged(const QString &arg1)
{
    ...
    ui->player_preview_widget->repaint();
    if (_loading == false) {
        sprintf(Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].graphic_filename, "%s", arg1.toStdString().c_str());
    }
}
...
void player_edit::on_player_sprite_w_valueChanged(int arg1)
{
    ...
    ui->player_preview_widget->repaint();
    if (_loading == false) {
        Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].sprite_size.width = arg1;
    }
}
...
void player_edit::on_player_sprite_h_valueChanged(int arg1)
{
    ...
    ui->player_preview_widget->repaint();
    if (_loading == false) {
        Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].sprite_size.height = arg1;
    }
}
...
void player_edit::on_player_hitarea_x_valueChanged(int arg1)
{
    ...
    ui->player_preview_widget->repaint();
    if (_loading == false) {
        Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].sprite_hit_area.x;
    }
}
...
void player_edit::on_player_hitarea_y_valueChanged(int arg1)
{
    ...
    ui->player_preview_widget->repaint();
    if (_loading == false) {
        Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].sprite_hit_area.y;
    }
}
...
void player_edit::on_player_hitarea_w_valueChanged(int arg1)
{
    ...
    ui->player_preview_widget->repaint();
    if (_loading == false) {
        Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].sprite_hit_area.w;
    }
}
...
void player_edit::on_player_hitarea_h_valueChanged(int arg1)
{
    ...
    ui->player_preview_widget->repaint();
    if (_loading == false) {
        Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].sprite_hit_area.h;
    }
}
...
{
    if (_loading == true) { return; }
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].move_speed = arg1 * 10;
}

void player_edit::on_damageModSpinBox_valueChanged(int arg1)
{
    if (_loading == true) { return; }
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].damage_modifier = arg1;
}

void player_edit::on_canDoubleJumpCheckBox_toggled(bool checked)
{
    if (_loading == true) { return; }
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].can_double_jump = checked;
}

void player_edit::on_CanAirDashCheckBox_toggled(bool checked)
{
    if (_loading == true) { return; }
     Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].can_air_dash = checked;
}

void player_edit::on_canShotDiagonal_toggled(bool checked)
{
    if (_loading == true) { return; }
    Mediator::get_instance()->game_data.players[Mediator::get_instance()->current_player].can_shot_diagonal = checked;
}

...
void player_edit::fill_players_data()
{
    ...
    ui->WeaponColorValueIndicator->setStyleSheet(QString("background-color: rgb(") + QString::number(Mediator::get_instance()->game_data.weapon_menu_colors[Mediator::get_instance()->current_weapon].r) + QString(", ") +  QString::number(Mediator::get_instance()->game_data.weapon_menu_colors[Mediator::get_instance()->current_weapon].g) + QString(", ") +  QString::number(Mediator::get_instance()->game_data.weapon_menu_colors[Mediator::get_instance()->current_weapon].b) + QString("); border-style: outset; border-width: 1px; border-color: black;"));

...
void artificial_inteligence_tab::on_ai_selector_currentIndexChanged(int index)
{
    ...
    std::string temp(Mediator::get_instance()->game_data.ai_types[index].name);
	ui->ai_name->setText(temp.c_str());
	// CHANCES

    ui->chance1->setValue(Mediator::get_instance()->game_data.ai_types[index].states[0].chance);
    ui->chance2->setValue(Mediator::get_instance()->game_data.ai_types[index].states[1].chance);
    ui->chance3->setValue(Mediator::get_instance()->game_data.ai_types[index].states[2].chance);
    ui->chance4->setValue(Mediator::get_instance()->game_data.ai_types[index].states[3].chance);
    ui->chance5->setValue(Mediator::get_instance()->game_data.ai_types[index].states[4].chance);
    ui->chance6->setValue(Mediator::get_instance()->game_data.ai_types[index].states[5].chance);
    ui->chance7->setValue(Mediator::get_instance()->game_data.ai_types[index].states[6].chance);
    ui->chance8->setValue(Mediator::get_instance()->game_data.ai_types[index].states[7].chance);
    // ACTIONS
    int action1 = Mediator::get_instance()->game_data.ai_types[index].states[0].action;
    int action2 = Mediator::get_instance()->game_data.ai_types[index].states[1].action;

    ui->action1->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[0].action);
    ui->action2->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[1].action);
    ui->action3->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[2].action);
    ui->action4->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[3].action);
    ui->action5->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[4].action);
    ...
    /*
    for (int i=0; i<4; i++) {
        change_action(i, Mediator::get_instance()->game_data.ai_types[index].states[i].action);
    }
    */

	// OPTIONS
    common::fill_ai_options_combo(Mediator::get_instance()->game_data.ai_types[index].states[0].action, ui->parameter1);
    common::fill_ai_options_combo(Mediator::get_instance()->game_data.ai_types[index].states[1].action, ui->parameter2);
    common::fill_ai_options_combo(Mediator::get_instance()->game_data.ai_types[index].states[2].action, ui->parameter3);
    common::fill_ai_options_combo(Mediator::get_instance()->game_data.ai_types[index].states[3].action, ui->parameter4);
    common::fill_ai_options_combo(Mediator::get_instance()->game_data.ai_types[index].states[4].action, ui->parameter5);
    ...
    ui->parameter2->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[1].extra_parameter);
    ui->parameter3->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[2].extra_parameter);
    ui->parameter4->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[3].extra_parameter);
    ui->parameter5->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[4].extra_parameter);
    ...
    ui->next2->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[1].go_to);
    ui->next3->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[2].go_to);
    ui->next4->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[3].go_to);
    ui->next5->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[4].go_to);
    ui->next6->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[5].go_to);
    ui->next7->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[6].go_to);
    ui->next8->setCurrentIndex(Mediator::get_instance()->game_data.ai_types[index].states[7].go_to);

	// delays
    ui->delay1->setValue(Mediator::get_instance()->game_data.ai_types[index].states[0].go_to_delay);
    ui->delay2->setValue(Mediator::get_instance()->game_data.ai_types[index].states[1].go_to_delay);
    ui->delay3->setValue(Mediator::get_instance()->game_data.ai_types[index].states[2].go_to_delay);
    ui->delay4->setValue(Mediator::get_instance()->game_data.ai_types[index].states[3].go_to_delay);
    ui->delay5->setValue(Mediator::get_instance()->game_data.ai_types[index].states[4].go_to_delay);
    ui->delay6->setValue(Mediator::get_instance()->game_data.ai_types[index].states[5].go_to_delay);
    ui->delay7->setValue(Mediator::get_instance()->game_data.ai_types[index].states[6].go_to_delay);
    ui->delay8->setValue(Mediator::get_instance()->game_data.ai_types[index].states[7].go_to_delay);
...
{
    if (index >= 0) {
        Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[index].action = action_n;
	...
	if (index == 0) {
        ...
        common::fill_ai_options_combo(Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[index].action, ui->parameter2);
	} else if (index == 2) {
        common::fill_ai_options_combo(Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[index].action, ui->parameter3);
	} else if (index == 3) {
        common::fill_ai_options_combo(Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[index].action, ui->parameter4);
    } else if (index == 4) {
        common::fill_ai_options_combo(Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[index].action, ui->parameter5);
    } else if (index == 5) {
        common::fill_ai_options_combo(Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[index].action, ui->parameter6);
    } else if (index == 6) {
        common::fill_ai_options_combo(Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[index].action, ui->parameter7);
    } else if (index == 7) {
...
void artificial_inteligence_tab::on_ai_name_textChanged(const QString &arg1)
{
    ...
    sprintf(Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].name, "%s", arg1.toStdString().c_str());
...
void artificial_inteligence_tab::on_chance1_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[0].chance = arg1;
}
...
void artificial_inteligence_tab::on_chance2_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[1].chance = arg1;
}
...
void artificial_inteligence_tab::on_chance3_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[2].chance = arg1;
}
...
void artificial_inteligence_tab::on_chance4_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[3].chance = arg1;
}
...
void artificial_inteligence_tab::on_chance5_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[4].chance = arg1;
}
...
void artificial_inteligence_tab::on_chance6_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[5].chance = arg1;
}
...
void artificial_inteligence_tab::on_chance7_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[6].chance = arg1;
}
...
void artificial_inteligence_tab::on_chance8_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[7].chance = arg1;
}
...
void artificial_inteligence_tab::on_parameter1_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[0].extra_parameter = index;
}
...
void artificial_inteligence_tab::on_parameter2_currentIndexChanged(int index)
{
    ...
    //std::cout << "#1 - AI[" << Mediator::get_instance()->current_ai << "].states[1].extra_parameter: " << Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[1].extra_parameter << std::endl;
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[1].extra_parameter = index;
    //std::cout << "#2 - AI[" << Mediator::get_instance()->current_ai << "].states[1].extra_parameter: " << Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[1].extra_parameter << std::endl;
...
void artificial_inteligence_tab::on_parameter3_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[2].extra_parameter = index;
}
...
void artificial_inteligence_tab::on_parameter4_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[3].extra_parameter = index;
}
...
void artificial_inteligence_tab::on_parameter5_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[4].extra_parameter = index;
}
...
void artificial_inteligence_tab::on_parameter6_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[5].extra_parameter = index;
}
...
void artificial_inteligence_tab::on_parameter7_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[6].extra_parameter = index;
}
...
void artificial_inteligence_tab::on_parameter8_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[7].extra_parameter = index;
}
...
void artificial_inteligence_tab::on_next1_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[0].go_to = index;
}
...
void artificial_inteligence_tab::on_next2_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[1].go_to = index;
}
...
void artificial_inteligence_tab::on_next3_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[2].go_to = index;
}
...
void artificial_inteligence_tab::on_next4_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[3].go_to = index;
}
...
void artificial_inteligence_tab::on_next5_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[4].go_to = index;
...
void artificial_inteligence_tab::on_next6_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[5].go_to = index;
...
void artificial_inteligence_tab::on_next7_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[6].go_to = index;
...
void artificial_inteligence_tab::on_next8_currentIndexChanged(int index)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[7].go_to = index;
...
void artificial_inteligence_tab::on_delay1_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[0].go_to_delay = arg1;
}
...
void artificial_inteligence_tab::on_delay2_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[1].go_to_delay = arg1;
}
...
void artificial_inteligence_tab::on_delay3_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[2].go_to_delay = arg1;
}
...
void artificial_inteligence_tab::on_delay4_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[3].go_to_delay = arg1;
}
...
void artificial_inteligence_tab::on_delay5_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[4].go_to_delay = arg1;
...
void artificial_inteligence_tab::on_delay6_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[5].go_to_delay = arg1;
...
void artificial_inteligence_tab::on_delay7_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[6].go_to_delay = arg1;
...
void artificial_inteligence_tab::on_delay8_valueChanged(int arg1)
{
    ...
    Mediator::get_instance()->game_data.ai_types[Mediator::get_instance()->current_ai].states[7].go_to_delay = arg1;

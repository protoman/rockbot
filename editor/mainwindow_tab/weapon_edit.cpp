...
void weapon_edit::on_weapon_name_textChanged(const QString &arg1)
{
    ...
    snprintf(Mediator::get_instance()->game_data.weapons[_selected_weapon].name, sizeof(Mediator::get_instance()->game_data.weapons[_selected_weapon].name), "%s", arg1.toStdString().c_str());
}

...
{
    if (_data_loading == true) return;
    snprintf(Mediator::get_instance()->game_data.stage_face_filename[_current_stage], sizeof(Mediator::get_instance()->game_data.stage_face_filename[_current_stage]), "%s", arg1.toStdString().c_str());
}

void game_properties_tab::on_lineEdit_textChanged(const QString &arg1)
{
    if (_data_loading == true) return;
    snprintf(Mediator::get_instance()->game_data.name, sizeof(Mediator::get_instance()->game_data.name), "%s", arg1.toStdString().c_str());
...
{
    if (_data_loading == true) return;
    snprintf(Mediator::get_instance()->game_data.boss_music_filename, sizeof(Mediator::get_instance()->game_data.boss_music_filename), "%s", arg1.toStdString().c_str());
}

void game_properties_tab::on_finalBossMusic_comboBox_currentIndexChanged(const QString &arg1)
{
    if (_data_loading == true) return;
    snprintf(Mediator::get_instance()->game_data.final_boss_music_filename, sizeof(Mediator::get_instance()->game_data.final_boss_music_filename), "%s", arg1.toStdString().c_str());
}
...
{
    if (_data_loading == true) return;
    snprintf(Mediator::get_instance()->game_data.got_weapon_music_filename, sizeof(Mediator::get_instance()->game_data.got_weapon_music_filename), "%s", arg1.toStdString().c_str());
...
{
    if (_data_loading == true) return;
    snprintf(Mediator::get_instance()->game_data.game_over_music_filename, sizeof(Mediator::get_instance()->game_data.game_over_music_filename), "%s", arg1.toStdString().c_str());
}

void game_properties_tab::on_stageSelectMusic_comboBox_currentIndexChanged(const QString &arg1)
{
    if (_data_loading == true) return;
    snprintf(Mediator::get_instance()->game_data.stage_select_music_filename, sizeof(Mediator::get_instance()->game_data.stage_select_music_filename), "%s", arg1.toStdString().c_str());
}
...
{
    if (_data_loading == true) return;
    snprintf(Mediator::get_instance()->game_data.stages_face_name[_current_stage], sizeof(Mediator::get_instance()->game_data.stages_face_name[_current_stage]), "%s", arg1.toStdString().c_str());
}

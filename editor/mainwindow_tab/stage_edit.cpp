...
{
    if (_data_loading == true) return;
    snprintf(Mediator::get_instance()->stage_data.stages[Mediator::get_instance()->currentStage].bgmusic_filename, sizeof(Mediator::get_instance()->stage_data.stages[Mediator::get_instance()->currentStage].bgmusic_filename), "%s", arg1.toStdString().c_str());
}

void stage_edit::on_stages_tab_stage_name_lineedit_textChanged(const QString &arg1)
{
    if (_data_loading == true) return;
    snprintf(Mediator::get_instance()->stage_data.stages[Mediator::get_instance()->currentStage].name, sizeof(Mediator::get_instance()->stage_data.stages[Mediator::get_instance()->currentStage].name), "%s", arg1.toStdString().c_str());
}
...
{
    if (_data_loading == true) return;
    snprintf(Mediator::get_instance()->stage_data.stages[Mediator::get_instance()->currentStage].dialog_face_graphics_filename, sizeof(Mediator::get_instance()->stage_data.stages[Mediator::get_instance()->currentStage].dialog_face_graphics_filename), "%s", arg1.toStdString().c_str());
}
...
{
    if (_data_loading == true) return;
    snprintf(Mediator::get_instance()->stage_data.stages[Mediator::get_instance()->currentStage].boss.name, sizeof(Mediator::get_instance()->stage_data.stages[Mediator::get_instance()->currentStage].boss.name), "%s", arg1.toStdString().c_str());
}

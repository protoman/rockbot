...
{
    if (data_loading) { return; }
    snprintf(Mediator::get_instance()->projectile_list_v3.at(Mediator::get_instance()->current_projectile).name, sizeof(Mediator::get_instance()->projectile_list_v3.at(Mediator::get_instance()->current_projectile).name), "%s", arg1.toStdString().c_str());
...
{
    if (data_loading) { return; }
    snprintf(Mediator::get_instance()->projectile_list_v3.at(Mediator::get_instance()->current_projectile).graphic_filename, sizeof(Mediator::get_instance()->projectile_list_v3.at(Mediator::get_instance()->current_projectile).graphic_filename), "%s", arg1.toStdString().c_str());
	ui->projectilePreviewAreaWidget->repaint();
}
...
{
    if (data_loading) { return; }
    snprintf(Mediator::get_instance()->projectile_list_v3.at(Mediator::get_instance()->current_projectile).sfx_filename, sizeof(Mediator::get_instance()->projectile_list_v3.at(Mediator::get_instance()->current_projectile).sfx_filename), "%s", arg1.toStdString().c_str());
}

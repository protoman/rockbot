...
void object_tab::on_graphicfile_combo_currentIndexChanged(const QString &arg1)
{
    ...
    snprintf(Mediator::get_instance()->object_list.at(_current_object).graphic_filename, sizeof(Mediator::get_instance()->object_list.at(_current_object).graphic_filename), "%s", arg1.toStdString().c_str());
...
void object_tab::on_name_textChanged(const QString &arg1)
{
    ...
    snprintf(Mediator::get_instance()->object_list.at(_current_object).name, sizeof(Mediator::get_instance()->object_list.at(_current_object).name), "%s", arg1.toStdString().c_str());

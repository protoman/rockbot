...
void stage_swap_dialog::on_buttonBox_accepted()
{
    ...
    snprintf(temp_face_name, sizeof(temp_face_name), "%s", Mediator::get_instance()->game_data.stages_face_name[dest_n]);
    snprintf(Mediator::get_instance()->game_data.stages_face_name[dest_n], sizeof(Mediator::get_instance()->game_data.stages_face_name[dest_n]), "%s", Mediator::get_instance()->game_data.stages_face_name[origin_n]);
    snprintf(Mediator::get_instance()->game_data.stages_face_name[origin_n], sizeof(Mediator::get_instance()->game_data.stages_face_name[origin_n]), "%s", temp_face_name);

    char temp_face_filename[FS_FACE_FILENAME_MAX];
    snprintf(temp_face_filename, sizeof(temp_face_filename), "%s", Mediator::get_instance()->game_data.stage_face_filename[dest_n]);
    snprintf(Mediator::get_instance()->game_data.stage_face_filename[dest_n], sizeof(Mediator::get_instance()->game_data.stage_face_filename[dest_n]), "%s", Mediator::get_instance()->game_data.stage_face_filename[origin_n]);
    snprintf(Mediator::get_instance()->game_data.stage_face_filename[origin_n], sizeof(Mediator::get_instance()->game_data.stage_face_filename[origin_n]), "%s", temp_face_filename);
